...
class UsersModel{
    ...
    // Devuelve una tabla con todos los datos del usuario 
    ...
    // Devuelve una tabla con todos los usuarios excepto el admin que está loggeado
    ...
    function getAllUsuarios(){
        $sentencia = $this->db->prepare("SELECT * FROM usuario order by alias asc");
        $sentencia->execute();
        return $sentencia->fetchAll(PDO::FETCH_OBJ);
    }
