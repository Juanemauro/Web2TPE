        ...
        {foreach  from=$usuarios item=usuario}
            <tr>
                ...
                {if $usuario->admin eq 0}
                    ...
                    <td><a href="hacerAdmin/{$usuario->id_usuario}" class="btn btn-warning">Hacer administrador</a></td>
                ...
                {else}
                    ...
                    <td><a href="sacarPermiso/{$usuario->id_usuario}" class="btn btn-warning">Eliminar permiso</a></td>
                    <td><a href="deleteUsuario/{$usuario->id_usuario}" class="btn btn-warning">Eliminar</a></td>
                {/if}                
            </tr>
        {/foreach}
